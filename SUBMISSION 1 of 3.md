...
```
    ...
    100.00%  117.345      1 -total
     81.61%   95.767      3 Template:Cite_web
      4.65%    5.453      1 Template:Canadian_postal_codes
      3.89%    4.570      1 Template:Col-2
      2.15%    2.528      1 Template:Col-begin
      2.12%    2.490      1 Template:Col-break
      1.78%    2.094      2 Template:Col-end
    -->
          <!-- Saved in parser cache with key enwiki:pcache:idhash:539066-0!canonical and timestamp 20191108195728 and revision id 920980179
     -->
         </div>
         <noscript>
    ...
    additional terms may apply.  By using this site, you agree to the
      ...
      <script>
       (RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgPageParseReport":{"limitreport":{"cputime":"0.196","walltime":"0.226","ppvisitednodes":{"value":574,"limit":1000000},"ppgeneratednodes":{"value":0,"limit":1500000},"postexpandincludesize":{"value":10232,"limit":2097152},"templateargumentsize":{"value":13,"limit":2097152},"expansiondepth":{"value":5,"limit":40},"expensivefunctioncount":{"value":0,"limit":500},"unstrip-depth":{"value":1,"limit":20},"unstrip-size":{"value":9025,"limit":5000000},"entityaccesscount":{"value":0,"limit":400},"timingprofile":["100.00%  117.345      1 -total"," 81.61%   95.767      3 Template:Cite_web","  4.65%    5.453      1 Template:Canadian_postal_codes","  3.89%    4.570      1 Template:Col-2","  2.15%    2.528      1 Template:Col-begin","  2.12%    2.490      1 Template:Col-break","  1.78%    2.094      2 Template:Col-end"]},"scribunto":{"limitreport-timeusage":{"value":"0.066","limit":"10.000"},"limitreport-memusage":{"value":1836545,"limit":52428800}},"cachereport":{"origin":"mw1329","timestamp":"20191108195728","ttl":2592000,"transientcontent":false}}});});
      </script>
      ...
      <script>
       (RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":83,"wgHostname":"mw1271"});});
      </script>
     </body>
    </html>
...
```python
# Parsed out tagged 'table' from formatted code
...
```python
# Notice the first row has a Borough and Neighborhood value of 'Not assigned' ?
...
```python
# From the table above, Neighbourhood thats has a value of 'Not assigned' will be assign the same value as it's Borough
...
```python
# Finally, using the '.shape' method we can now print the number of rows in our dataframe
